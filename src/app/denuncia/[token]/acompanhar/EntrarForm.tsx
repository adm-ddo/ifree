...
import { entrarComProtocolo } from "./actions";

export default function EntrarForm({ token }: { token: string }) {
  const [state, formAction, pending] = useActionState(entrarComProtocolo.bind(null, token), undefined);
