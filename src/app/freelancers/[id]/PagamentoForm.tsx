...
export default function PagamentoForm({
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className="font-semibold text-navy-900">Pagamento</h2>
        <p className="text-xs text-stone-500 mt-1">
          Só o dono decide o modo de pagamento dessa pessoa nesta empresa — ela
          não escolhe no totem.
        </p>
      </div>
        ...
        <label className="flex items-start gap-2 rounded-lg border border-stone-200 px-3 py-2.5 has-[:checked]:border-brand-400 has-[:checked]:bg-brand-50 cursor-pointer">
          ...
          <span>
            ...
            <span className="block text-xs text-stone-500">
              Valor/hora da função, arredondado por bloco de 5min (padrão).
            </span>
          </span>
        </label>
        <label className="flex items-start gap-2 rounded-lg border border-stone-200 px-3 py-2.5 has-[:checked]:border-brand-400 has-[:checked]:bg-brand-50 cursor-pointer">
          ...
          <span>
            ...
            <span className="block text-xs text-stone-500">
              Valor combinado com a pessoa, escalonado pelas faixas de horas
              configuradas em Configurações.
            </span>
          </span>
        </label>
      </div>
      ...
      <div className="border-t border-stone-100 pt-3 flex flex-col gap-2">
        ...
        <label className="flex items-start gap-2 rounded-lg border border-stone-200 px-3 py-2.5 has-[:checked]:border-brand-400 has-[:checked]:bg-brand-50 cursor-pointer">
          ...
          <span>
            ...
            <span className="block text-xs text-stone-500">
              Acumula os turnos da semana (dias e dia de pagamento
              configurados em Configurações) pra pagar tudo de uma vez.
            </span>
          </span>
        </label>
      </div>
