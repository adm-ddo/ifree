...
import { resgatarConviteEquipe } from "./actions";

export default function CadastrarViaConviteForm({ token }: { token: string }) {
  const [state, formAction, pending] = useActionState(resgatarConviteEquipe, undefined);
